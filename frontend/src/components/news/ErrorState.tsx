      ...
      <div className="relative flex min-h-[412px] w-full flex-col items-center justify-center rounded-[calc(var(--radius-xl)-4px)] border border-white/50 bg-card p-8 backdrop-blur-xl">
        ...
        {onRetry ? (
          <button
            type="button"
            onClick={onRetry}
            className="mt-7 inline-flex items-center gap-2 rounded-full bg-foreground px-5 py-3 text-sm font-semibold text-background transition hover:scale-[1.02] focus:outline-none focus:ring-4 focus:ring-foreground/15"
          >
